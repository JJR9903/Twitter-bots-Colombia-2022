...
# -*- coding: utf-8 -*-
"""
Created on Mon May 23 20:19:53 2022
...
# -*- coding: utf-8 -*-
"""
Created on Mon May 23 17:17:37 2022
...
#Save df
df=pd.concat(rows)
df.to_pickle('Marcas 2k_4k.pkl')

#Save dict
try:
	geeky_file = open('Res 2k_4k', 'wb')
...
#To read
#file_to_read = open("Res 2k_4k", "rb")
